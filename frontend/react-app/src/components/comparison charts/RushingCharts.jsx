...
const RushingCharts = ({player1Statlines, player2Statlines, player1, player2}) => {
    ...
    const rushYdsData = getChartData("rush_yds");
    const rushTdsData = getChartData("rush_tds");
    const fumblesData = getChartData("fum_lost");
    const rushAttData = getChartData("rush_attempts");
        ...
        <div>
            <div className="flex justify-center space-x-2 h-96 mt-2">
                ...
                <div className="flex flex-col justify-center items-center bg-white w-full">
                    <h3 className="text-lg text-gray-500">Rushing Yards</h3>
                    {(player1Statlines.length > 0 || player2Statlines.length > 0) && (
                        <AreaChart width={700} height={350} data={rushYdsData} margin={CHART_MARGIN} >
                ...
                {/* Rushing Touchdowns Chart */}
                <div className="flex flex-col justify-center items-center bg-white w-full">
                    <h3 className="text-lg text-gray-500">Rushing Touchdowns</h3>
                    {(player1Statlines.length > 0 || player2Statlines.length > 0) && (
                        <BarChart width={700} height={350} data={rushTdsData} margin={CHART_MARGIN} >
            ...
            <div className="flex justify-center space-x-2 h-96 mt-2">
                ...
                {/* Rush Attempts Chart */}
                <div className="flex flex-col justify-center items-center bg-white w-full">
                    <h3 className="text-lg text-gray-500">Rush Attempts</h3>
                    {(player1Statlines.length > 0 || player2Statlines.length > 0) && (
                        <AreaChart width={700} height={350} data={rushAttData} margin={CHART_MARGIN} >
                            <defs><ChartGradients /></defs>
                            <CartesianGrid stroke="#f5f5f5" />
                            <XAxis dataKey="game" />
                            <YAxis />
